...
4. Send the typed report to confirm it shows the same diagnostic preview and can be sent or discarded.
5. Confirm the diagnostic preview does not include Entry content, unrelated diagnostic notes, Contact details, shared payload bodies, or attachments.
