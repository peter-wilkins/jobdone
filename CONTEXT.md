...
- Runtime/model loading should start only after the user has completed at least one successful backend voice Capture, then continue lazily in the background. Once Local Transcription is ready, JobDone should prefer it for Capture and keep backend transcription as fallback.
