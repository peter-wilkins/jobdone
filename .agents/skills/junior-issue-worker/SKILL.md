...
description: Implements exactly one assigned GitHub issue as a junior branch worker and opens a draft PR for review. Use when the user asks a junior, Spark, or lower-cost agent to do an issue, pick up a ticket, or prepare implementation for senior review.
---
